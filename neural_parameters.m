...
%---------------------------------------------------------------------
LP_fc = 40;  % low-pass filter cut-off
Fs_new = 100; % down-sample to Fs_new (Hz)
...
feat_params_st.spectral.L_window = 0.25; % in seconds
...
feat_params_st.rEEG.L_window = 0.25; % in seconds
...
feat_params_st.connectivity.L_window = 0.25; % PSD window in seconds
